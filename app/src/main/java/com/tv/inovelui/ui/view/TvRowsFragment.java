 ...
 * 开发状况：正在开发中
 * 开发作者：黎丝军
 * 开发时间：2017/5/23- 12:48
 */

public class TvRowsFragment extends TvBaseRowFragment implements
        TvBrowseFragment.MainFragmentRowsAdapterProvider,
        TvBrowseFragment.MainFragmentAdapterProvider {

    private MainFragmentAdapter mMainFragmentAdapter;
    private MainFragmentRowsAdapter mMainFragmentRowsAdapter;

    @Override
    public TvBrowseFragment.MainFragmentAdapter getMainFragmentAdapter() {
    ...
    @Override
    public TvBrowseFragment.MainFragmentRowsAdapter getMainFragmentRowsAdapter() {
    ...
    /**
     * @deprecated use {@link TvBrowseFragment#enableRowScaling(boolean)} instead.
     *
    ...
    static void setRowViewSelected(ItemBridgeAdapter.ViewHolder vh, boolean selected,
                                   boolean immediate) {
        TvRowsFragment.RowViewHolderExtra extra = (TvRowsFragment.RowViewHolderExtra) vh.getExtraObject();
    ...
    private final ItemBridgeAdapter.AdapterListener mBridgeAdapterListener =
            new ItemBridgeAdapter.AdapterListener() {
                ...
                public void onCreate(ItemBridgeAdapter.ViewHolder vh) {
                    ...
                    mViewsCreated = true;
                    vh.setExtraObject(new TvRowsFragment.RowViewHolderExtra(vh));
     ...
     * @param smooth True to scroll to the row, false for no a nimation.
    ...
    public static class MainFragmentAdapter extends TvBrowseFragment.MainFragmentAdapter<TvRowsFragment> {

        public MainFragmentAdapter(TvRowsFragment fragment) {
            super(fragment);
    ...
    public static class MainFragmentRowsAdapter
            extends TvBrowseFragment.MainFragmentRowsAdapter<TvRowsFragment> {

        public MainFragmentRowsAdapter(TvRowsFragment fragment) {
            super(fragment);
        }
