 ...
 * 开发状况：正在开发中
 * 开发作者：黎丝军
 * 开发时间：2017/5/23- 11:59
 */

public abstract class TvBaseRowFragment extends Fragment {
    ...
    public void onTransitionEnd() {
        ...
        if (mVerticalGridView != null) {
            ...
            setScrollEnabled(mVerticalGridView, true);
        }
    }

    /**
     * 设置列表是否需要滚动
     * @param verticalGridView 列表视图
     * @param scrollEnabled true表示需要，false表示不需要
     */
    protected void setScrollEnabled(VerticalGridView verticalGridView, boolean scrollEnabled) {
        verticalGridView.setScrollEnabled(scrollEnabled);
    }
