...
public class VerticalGridFragment extends Fragment
    ...
    private BrowseFragment.MainFragmentAdapter mMainFragmentAdapter = new BrowseFragment.MainFragmentAdapter<VerticalGridFragment>(this) {
                @Override
                public void setEntranceTransitionState(boolean state) {
                    VerticalGridFragment.this.setEntranceTransitionState(state);
                }
            };
    /**
